document.addEventListener('DOMContentLoaded', () => {
  ...
  if (formModifVehicule) {
    formModifVehicule.addEventListener('submit', async (e) => {
      ...
      try {
        const res = await fetch('index.php?page=modifier_vehicule', {
          method: 'POST',
          body: formData
        });
  ...
  if (userRole === 'admin') {
    ...
    if (adminBtn) {
      ...
      adminBtn.addEventListener('click', () => {
        window.location.href = 'index.php?page=creer_employe';
      });
    }
  }
};
...
if(editForm) {
  editForm.addEventListener('submit', async (e) => {
    e.preventDefault();
      ...
      try {
        const response = await fetch('index.php?page=modifier_profil', {
          method: 'POST',
          body: formData
        });
